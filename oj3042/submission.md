...
Output: รับจำนวนเต็มบวกตั้งเเต่ N ถึง 0 ที่ 10 หารลงตัว
```
...
```text
Step 1: รับจำนวนเต็มบวก N 
Step 2: ใช้ลูป N ถึง 0
Step 3:ตรวจสอบว่าหาร10ลงตัว
```
...
```text
วิธีสุดท้ายของผมหมือนกับเเผนเเรกเลยครับ
```
...
```text
ค่าต่ำสุด ของการวนลูป โปรแกรมต้องแสดง 0
```
...
```text
ทดสอบกรณีที่ไม่มีเลขที่หาร 10 ลงตัวนอกจาก 0
```
...
```text
ทดสอบค่าที่เป็น พหุคูณของ 10 พอดี
```
