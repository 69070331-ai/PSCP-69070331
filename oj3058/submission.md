...
```text
Input: รับอิฐเล็ก อิฐใหญ่ เเละความยาวของสะพานที่ต้องการ
Output: จำนวนอิฐเล็กที่ต้องใช้
```
...
```text
Step 1: รับอิฐเล็ก อิฐใหญ่ เเละความยาวของสะพานที่ต้องการ
Step 2: หาจำนวนอิฐใหญ่ที่ใช้ได้
Step 3: คำนวณความยาวที่เหลือหลังจากใช้อิฐใหญ่
Step 4: ตรวจสอบว่าอิฐเล็กพอไหม
```
...
```text
ใช้วิธีสุดท้ายเหมือนกับแผนแรกที่คิดเลยครับ
```
...
```text
กรณีทั่วไป ใช้อิฐใหญ่ก่อน แล้วใช้อิฐเล็กเติมจนพอดี
```
...
```text
อิฐเล็กไม่เพียงพอ ทดสอบเงื่อนไข else
```
...
```text
อิฐใหญ่มีไม่พอ ต้องใช้อิฐเล็กเพิ่ม
```
