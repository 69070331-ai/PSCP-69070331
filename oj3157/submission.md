...
```text
Input: รับจำนวนคำสั่ง N แล้วรับคำสั่ง + หรือ - จำนวน N ครั้ง
Output: แสดงคะแนนรวมสุดท้าย โดย + = 10 คะแนน และ - = -5 คะแนน
```
...
```text
Step 1: อ่านจำนวนคำสั่ง N
Step 2: กำหนดคะแนนเริ่มต้นเป็น 0
Step 3: รับคำสั่ง + หรือ - จำนวน N ครั้ง
Step 4: ถ้าคำสั่งเป็น + ให้เพิ่มคะแนน 10
Step 5: ถ้าคำสั่งเป็น - ให้ลดคะแนน 5
Step 6: พิมพ์คะแนนรวมสุดท้าย
```
...
```text
ทดสอบการคำนวณหลายคำสั่งและการสลับ +/-
```
...
```text
ตรวจสอบกรณีมีแต่คำสั่งเพิ่มคะแนน
```
