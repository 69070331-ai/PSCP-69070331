...
```text
input : รับจำนวนเต้มเป็นวันเเละเดือน
Output : เขียนฤดูที่เข้าเงื่อนไข
```
...
```text
Step 1: รับเดือนกับวันเข้ามา
Step 2: ตรวจว่าเป็นวันที่21ขึ้นไปเเละเป็นเดือน 3 6 9 12 ไหม
Step 3: ตรวจว่าถ้าเป็นเดือน 3 6 9 12 ต้องเป็นฤดูอะไร
Step 4: เเล้วถ้าไม่เข้าเงื่อนไขเเรกเเต่ละเดือนต้องเป็นอะไร
```
...
```text
ใช้วิธีเดียวกับที่เขียนในข้อเมื่อกี้ 
```
...
```text
ทดสอบวันก่อนเปลี่ยนจาก Winter → Spring
```
