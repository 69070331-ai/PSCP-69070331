...
| OJ submission ID, if submitted | 588894 |
| OJ status | Pass |
...
```text
ผมใช้เพื่อตีกรอบว่าต้องทำอะไรบ้าง เพราะตอนเเรกผมยังงงว่าต้องทำอะไรบ้าง
```
...
```text
if day >= 21 and not month % 3: ตรงนี้ครับตอนเเรกผมลืมจะทำยังให้เป็นเดือน 3 6 9 12 เเต่พอเอไอช่วยตีกรอบให้ผมเลยทำได้ครับ
```
...
```text
ผมเขียนโค้ดเองเกือบทั้งหมดเลยครับพอเริ่มได้ก็ทำต่อเองเรื่อยๆเลยครับ
```
...
```text
บางข้ออาจไม่ยากเเค่เราต้องตีโจทย์ให้ออก 
```
