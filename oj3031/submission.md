...
```text
Input: รับ S และ N จากนั้นรับพิกัด x, y ของบ้านแต่ละหลัง
Output: แสดงเวลาที่หมึกจะท่วมบ้านแต่ละหลัง โดยปัดเศษเวลาขึ้นเป็นจำนวนเต็ม
...
```text
Step 1: รับค่า S และ N
Step 2: วนรับพิกัด x, y ของบ้านแต่ละหลัง
Step 3: คำนวณพื้นที่วงกลม = 3.1416 × (x² + y²)
Step 4: คำนวณเวลา = พื้นที่ ÷ S
Step 5: ปัดเวลาเศษขึ้น แล้วแสดงผล
```
...
```text
ทดสอบบ้านที่อยู่ใกล้จุดเริ่มต้น
```
