...
```text
Input: บรรทัดแรก S N
S = พื้นที่หมึกที่เพิ่มขึ้นต่อ 1 วินาที
N = จำนวนบ้าน
จากนั้นรับพิกัด x y ของบ้านแต่ละหลัง
Output: แสดง จำนวนวินาทีที่หมึกจะท่วมบ้านแต่ละหลัง ทีละ 1 บรรทัด
ถ้าคำนวณเวลาได้เป็นทศนิยม
```
...
```text
Step 1: อ่านค่า S และ N
Step 2: อ่านพิกัด x, y ของบ้านแต่ละหลัง
Step 3: คำนวณพื้นที่หมึก = 3.1416 × (x² + y²)
Step 4: คำนวณเวลา = พื้นที่หมึก ÷ S
Step 5: ปัดเวลาเป็นจำนวนเต็มถัดไป แล้วพิมพ์คำตอบ
...
```text
วิธีสุดท้ายเหมือนเเผนเเรกเลยครับ
```
...
```text
ทดสอบกรณีบ้านอยู่ใกล้จุดกำเนิด
```
...
```text
ทดสอบกรณีต้องคำนวณพื้นที่จากทั้ง x และ y
```
...
```text
ทดสอบกรณีบ้านอยู่ตรงจุดที่หมึกเริ่มตก
```
