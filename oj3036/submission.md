...
```text
Input: รับจำนวนเต็ม N 1 ค่า
Output: แสดงจำนวนเต็ม answer 1 ค่า ซึ่งเป็นคำตอบที่คำนวณจากตำแหน่งของ N 
```
...
```text
Step 1: รับค่า N
Step 2: หาค่า r ที่เป็นรากที่สองของ N แล้วปัดขึ้น
Step 3: หาตำแหน่งของ N ในชั้นนั้น
Step 4: ตรวจว่าตำแหน่งเป็นเลขคู่หรือคี่
Step 5: คำนวณคำตอบจาก r และตำแหน่ง
Step 6: แสดงคำตอบ
...
```text
ทดสอบกรณี N อยู่ระหว่างกำลังสอง
```
