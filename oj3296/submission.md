...
```text
Input:
โปรแกรมรับจำนวนเต็ม 6 ค่า
r1, g1, b1 คือค่า RGB ของสีที่ 1
r2, g2, b2 คือค่า RGB ของสีที่ 2

Output:
โปรแกรมควรพิมพ์ค่า RGB ใหม่ โดยนำค่า R, G และ B ของสีทั้งสองมาหาค่าเฉลี่ย
และใช้การหารจำนวนเต็ม

Constraints:
ค่า RGB เป็นจำนวนเต็ม
ค่าแต่ละช่องของสีอยู่ในช่วง 0 ถึง 255
```
...
```text
Step 1: อ่านค่า r1, g1, b1 ของสีที่ 1
Step 2: อ่านค่า r2, g2, b2 ของสีที่ 2
Step 3: คำนวณค่า R ใหม่ด้วย (r1 + r2) // 2
Step 4: คำนวณค่า G ใหม่ด้วย (g1 + g2) // 2
Step 5: คำนวณค่า B ใหม่ด้วย (b1 + b2) // 2
Step 6: พิมพ์ค่า R, G และ B ที่คำนวณได้
```
...
```text
ทดสอบการนำสีแดงกับสีน้ำเงินมาผสมกัน และตรวจสอบการคำนวณค่าเฉลี่ยของแต่ละช่อง
```
...
```text
ทดสอบกรณีที่สีทั้งสองเหมือนกัน ผลลัพธ์ควรเป็นสีเดิม
...
```text
ทดสอบการใช้ // 2 เมื่อผลรวมเป็นเลขคี่ เพื่อดูว่าการปัดเศษลงทำงานถูกต้องครับ
```
