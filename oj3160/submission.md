...
```text
Input : รับจำนวนเต็ม start และ end โดยเป็นช่วงที่ต้องการตรวจหาจำนวนเฉพาะ
Output : แสดงจำนวนเฉพาะที่อยู่ในช่วง start ถึง end และแสดงจำนวนจำนวนเฉพาะทั้งหมด
...
```text
Step 1: อ่านค่า start และ end
Step 2: ตรวจสอบตัวเลขทุกตัวตั้งแต่ start ถึง end
Step 3: ถ้าตัวเลขน้อยกว่า 2 ให้ข้ามไป
Step 4: ตรวจสอบว่าตัวเลขนั้นหารด้วยจำนวนตั้งแต่ 2 ถึง √n ลงตัวหรือไม่
Step 5: ถ้าหารไม่ลงตัว แสดงว่าเป็นจำนวนเฉพาะ และเก็บไว้ใน primes
Step 6: แสดงจำนวนเฉพาะทั้งหมด
Step 7: แสดงจำนวนจำนวนเฉพาะทั้งหมดด้วย len(primes)
```
...
```text
ทดสอบช่วงทั่วไปและมีจำนวนเฉพาะหลายตัว
```
...
```text
ทดสอบช่วงที่เริ่มจากเลขมากกว่า 2
```
