...
| OJ submission ID, if submitted | 589141 |
| OJ status | Pass |
...
```text
ถามเรื่องจะหาคะเเนนที่น้อยที่สุดยังไง
```
...
```text
ช่วยให้ผมรู้วิธีการหาค่าที่น้อยที่สุดไว้ใช้กับข้ออื่น
```
...
```text
หลังจากรู้วิธีที่เหลือก็เขียนเองหมดเลยครับ
```
...
```text
เราต้องตีโจทย์เเล้วคิดวิธีที่ง่ายที่สุดให้ออก ในโจทย์นี้ผมคิดวิธีหาค่าที่น้อยที่สุดไม่ออกทำให้ทำต่อไม่ได้
```
