...
```text
Input: รับคะแนนรวมเเละคะแนนที่มากที่สุด
Output: ตรวจว่าคนที่คะเเนนมากสุดกับน้อยสุดต่างกัน 2 ไหมเเล้วปริ้น"Surprising" หรือ "Not surprising"
```
...
```text
Step 1: รับคะแนนรวมเเละคะแนนที่มากที่สุด
Step 2: หาค่าที่เหลือโดยเอาคะเเนนทั้งหมดลบกับคะเเนนที่มากที่สุด
Step 3: นำค่าที่เหลือมาลบกับคะเเนนที่มากที่สุดจะได้คะเเนนน้อยที่สุด
Step 4: นำคะเเนนมากที่สุดกับคะเเนนน้อยที่สุดมาลบกันเเล้วดูว่ามากกว่าหรือน้อยกว่า2
Step 5: เเล้วปริ้น"Surprising" หรือ "Not surprising"
```
