...
```text
Input:
โปรแกรมรับจำนวนเต็ม 2 ค่า L และ N
L คือขนาดของแถบ
N คือจำนวนช่องที่ปลูกดอกไม้

Output:
โปรแกรมควรพิมพ์หมายเลขของแถบที่มีช่องที่ N อยู่

Constraints:
L และ N เป็นจำนวนเต็ม
L มีค่าตั้งแต่ 1 ถึง 10
N มีค่าตั้งแต่ 1 ถึง 100,000
```
...
```text
Step 1: อ่านจำนวนเต็ม L และ N
Step 2: กำหนดค่า line = 0 และ total = 0
Step 3: เพิ่มค่า line ทีละ 1 และนำ line ไปบวกกับ total จนกว่า total จะมากกว่าหรือเท่ากับ N
Step 4: คำนวณหมายเลขแถบด้วย (line + L - 1) // L
Step 5: พิมพ์ค่า band
```
...
```text
วิธีสุดท้ายของเหมือนกับแผนแรกครับ
...
```text
ทดสอบกรณีทั่วไปที่ N อยู่ในแถวที่ 6 และ L = 1
```
...
```text
จำนวนช่องสะสมคือ 1+2+3+4 = 10 เพื่อดูว่าโปรแกรมจัดการกรณีที่ N ตรงกับจำนวนช่องสะสมพอดีได้ถูกต้อง
```
...
```text
ทดสอบการคำนวณ band เมื่อ L มากกว่า 1 เพื่อให้แน่ใจว่าสามารถแบ่งแถวออกเป็นแถบได้ถูกต้องครับ
