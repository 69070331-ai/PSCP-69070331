...
```text
input : รับราคาสินค้าเข้ามา
Output : แสดงยอดเงินรวมหลังบวกค่าบริการและ VAT 7% เเละต้องเป็นทศนิยม 2 ตำเเหน่งด้วย
```
...
```text
Step : 1รับราคาสินค้า
Step : 2คำนวณค่าบริการ 10%
Step : 3เช็กค่าบริการให้อยู่ระหว่าง 50 - 1000 บาท
Step 4 :รวมราคาสินค้ากับค่าบริการ
Step 5 :เพิ่มภาษี VAT 7%
Step 6 :แสดงยอดเงินที่ต้องจ่ายทั้งหมด
```
...
```text
ผมยังใช้วิธีเดิมครับโดยรับราคาสินค้า นำไปคำนวณค่าบริการ 10% จากนั้นปรับค่าให้อยู่ในช่วง 50-1000 บาท แล้วนำไปรวมกับราคาและคิด VAT 7% ก่อนแสดงยอดเงินสุดท้ายเป็นทศนิยม 2 ตำแหน่ง
```
...
```text
ตรวจสอบปรับค่าบริการขั้นต่ำเป็น 50 บาทไหม
```
...
```text
การคำนวณ Service Charge และ VAT ว่าถูกต้องไหม
```
...
```text
ะบบจำกัดค่าบริการสูงสุดไว้ที่ 1000 บาทได้ถูกต้องไหม
```
