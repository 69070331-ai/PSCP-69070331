...
```text
Input: รับรหัสสมาชิก จำนวนสินค้า และราคาสินค้าแต่ละรายการ
Output: แสดงยอดเงินรวมหลังหักส่วนลด โดยมีทศนิยม 2 ตำแหน่ง
```
...
```text
Step 1: รับรหัสสมาชิก จำนวนสินค้า และราคาสินค้าแต่ละรายการ
Step 2: รวมราคาสินค้าทั้งหมด
Step 3: ถ้าเป็นสมาชิก Y ให้ลด 5%
Step 4: ถ้าไม่เป็นสมาชิกและยอดซื้อถึง 500 บาท ให้ลด 3%
Step 5: ปัดยอดรวมให้เหลือทศนิยม 2 ตำแหน่ง แล้วแสดงผล
```
...
```text
ทดสอบกรณีเป็นสมาชิกและได้รับส่วนลด 5%
```
...
```text
ทดสอบกรณีไม่เป็นสมาชิก แต่ยอดซื้อถึง 500 บาท จึงได้ส่วนลด 3%
```
...
```text
ทดสอบกรณีไม่เป็นสมาชิกและยอดซื้อไม่ถึง 500 บาท จึงไม่ได้รับส่วนลด
```
