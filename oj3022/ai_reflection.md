...
| OJ submission ID, if submitted | 588457 |
| OJ status | Pass |
...
```text
ใช้ถามว่าควรใช้วิธีไหนในการคำนวณดีเพราะตอนเเรกผมยังงงอยู่ว่าควรใช้วิธีไหน
```
...
```text
ทำให้ผมรู้ว่าสามารถใช้วิธีเเปลงเป็นองศาเซลเซียสเพื่อให้ง่ายต่อการคำนวณได้
```
...
```text
หลังจากที่รู้ว่าต้องทำยังไงบ้างก็เขียนต่อเองเลยครับ
```
...
```text
การเลือกใช้วิธีเป็นสิ่งที่สำคัญเพราะทำให้เขียนโค้ดง่ายขึ้นมาก
```
