...
```text
Input: รับค่าอุณภูมิเเละรับหน่วยต้นทางเเละปลายทาง
Output: เป็นอุณภูมิหลังเเปลงเเละเป็นทศนิยม2ตำเเหน่ง
```
...
```text
Step 1: รับค่าอุณภูมิเเละรับหน่วยต้นทางเเละปลายทาง
Step 2: ผมจะทำให้ทุกหน่วยเป็นองศาเซลเซียสก่อน
Step 3: เเล้วนำไปเเปลงต่อเป็นหน่วยที่ต้องการ
```
...
```text
ใช้วิธีสุดท้ายเหมือนเเผนเเรกเลยครับ
```
...
```text
ทดสอบการแปลงจาก Celsius → Fahrenheit
```
