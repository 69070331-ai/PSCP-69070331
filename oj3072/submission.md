...
Output: วนลูปแสดงผลเฉพาะสระที่มีจำนวนมากกว่า 0
```
...
```text
Step 1: รับข้อความจากผู้ใช้
Step 2: แปลงข้อความทั้งหมดเป็นตัวพิมพ์เล็กด้วย .lower()
Step 3: สร้างArrayพื่อเก็บจำนวนสระทั้ง 5 ตัว
Step 4: วนลูปอ่านตัวอักษรทีละตัว
Step 5: ถ้าเป็นสระ (a, e, i, o, u) ให้หาตำแหน่งของสระใน VOWELS
Step 6: เพิ่มค่าที่ตำแหน่งนั้นใน Array
Step 7: วนลูปแสดงผลเฉพาะสระที่มีจำนวนมากกว่า 0
```
...
```text
ทดสอบการนับสระตัวเดียวหลายครั้ง
```
...
```text
ทดสอบข้อความที่มีทั้งตัวอักษร ช่องว่าง และสระหลายตำแหน่ง
```
