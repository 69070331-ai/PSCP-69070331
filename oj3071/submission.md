...
```text
Step 1: รับค่าจำนวนเต็ม A, B, d และ r
Step 2: คำนวณจำนวนที่หารด้วย d แล้วเหลือเศษ r ที่มีค่าไม่เกิน B
Step 3: คำนวณจำนวนที่หารด้วย d แล้วเหลือเศษ r ที่มีค่าไม่เกิน A - 1
Step 4: นำค่าจาก Step 2 มาลบกับค่าจาก Step 3 เพื่อหาจำนวนที่อยู่ในช่วง [A, B]
Step 5: พิมพ์ผลลัพธ์ออกมา
```
...
```text
วิธีสุดท้ายเหมือนกับแผนแรกครับ
...
```text
ใช้ทดสอบกรณีปกติที่มีหลายจำนวนในช่วงที่หารด้วย d แล้วเหลือเศษ r
```
...
```text
ทดสอบว่าผลลัพธ์สามารถนับจำนวนที่ตรงเงื่อนไขได้ถูกต้อง
```
...
```text
ทดสอบกรณีที่มีจำนวนตรงเงื่อนไขเพียงตัวเดียว
```
