...
```text
input = รับชื่อสี2บรรทัด เช่น Red Blue Yellow
Output = สีได้จากผสมสี เช่น Red + Blue = violet ถ้าเป็นนอกจากนี้พิม Error
Constaints =รับข้อมูลทั้งหมด 2 ค่าเท่านั้นเเละข้อมูลเป็นข้อความ 
```
...
```text
Step 1 : รับค่ามา2สี
Step 2 : ตรวจสอบว่าเป็นเเม่สีไหม
Step 3 : ดูคู่สีที่เอามาผสม
Step 4 : ถ้าไม่ตรงกับเงื่อนไขพิม Error
```
...
```text
ใช้วิธีเดิมโดยตรวจก่อนว่าเป็นเเม่สีไหมทั้ง2inputเเล้วนำสีที่ได้มาผสมกันถ้าไม่อยู่ในเงื่อนไขก็พิมError โดยมีเพื่อนคอยช่วยอธิบายให้ผมเข้าใจมากขึ้น
```
...
```text
เพราะเป็นอันที่ง่ายเพื่อตรวจสอบว่าโค้ดถูกไหม
```
...
```text
เป็นการเช็คว่าถ้าสีไม่อยู่ในเงื่อนไขจะเกิดอะไรขึ้น
```
...
```text
ช่วยอธิบายโจทย์ให้ว่าต้องเขียนอะไรบ้าง
```

คุณยังทำอะไรด้วยตนเอง

```text
เขียนโค้ดเองทั้งหมดถึงจะผิดหลายรอบเเต่ก็ผ่านจนได้
```
