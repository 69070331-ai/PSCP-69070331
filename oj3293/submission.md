...
```text
Input:
โปรแกรมรับข้อความจำนวน 5 บรรทัด
แต่ละบรรทัดสามารถมีตัวอักษร ตัวเลข และเว้นวรรคได้

Output:
โปรแกรมควรพิมพ์ข้อความทั้ง 5 บรรทัดภายในกรอบที่สร้างจากเครื่องหมาย *
โดยมีช่องว่างระหว่างข้อความกับกรอบด้านซ้ายและด้านขวา 1 ช่อง
และใช้ความยาวของข้อความที่ยาวที่สุดเป็นความกว้างของกรอบ

Constraints:
รับข้อความทั้งหมด 5 บรรทัด
แต่ละบรรทัดอาจมีความยาวแตกต่างกัน
...
```text
Step 1: รับข้อความจำนวน 5 บรรทัดและเก็บไว้ใน List
Step 2: หาความยาวของข้อความที่ยาวที่สุด
Step 3: พิมพ์กรอบด้านบนด้วยเครื่องหมาย *
Step 4: วนแสดงข้อความทั้ง 5 บรรทัด โดยเติมช่องว่างให้มีความยาวเท่ากัน
Step 5: พิมพ์กรอบด้านล่างด้วยเครื่องหมาย *
```
...
```text
วิธีสุดท้ายของผมเหมือนกับแผนแรก
```
...
```text
ทดสอบกรณีที่แต่ละบรรทัดมีความยาวแตกต่างกัน และต้องเติมช่องว่างให้เท่ากับบรรทัดที่ยาวที่สุด
```
...
```text
ทดสอบกรณีที่ข้อความทุกบรรทัดมีความยาวเท่ากัน ไม่ต้องเติมช่องว่างเพิ่มเติม
```
...
```text
ทดสอบการเติมช่องว่างด้านขวาให้กับข้อความที่สั้นกว่าบรรทัดที่ยาวที่สุดครับ
